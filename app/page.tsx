...
export default function Home() {
  ...
  subtitle="Truely helps with anything it sees or hears."
  features={[
    {
    ...
    },
    {
      ...
      description:
        "Truely listens silently in the background and understands your meetings in real time — without ever joining them.",
    ...
    },
    {
      ...
      description:
        "Just press a key. Truely knows what you’re doing and responds with exactly what matters — no switching tabs, no guesswork.",
  ...
  features={[
    {
      ...
      description:
        "Truely never shows up in shared screens, recordings, or external meeting tools. It’s fully hidden from everyone but you.",
    ...
    },
    {
      ...
      description:
        "Truely’s window is fully moveable so you can position it exactly where you’re looking — without ever breaking concentration.",
...
/>
<Usage
  title="Three ways Truely changes how you think."
  sections={[
    {
      title: "Meetings",
      description:
        "Truely hears the conversation and gives you live, context-aware responses to questions, and recalls information from earlier in the transcript so you never lose the thread.",
    ...
    },
    {
      title: "Sales calls",
      description:
        "Truely helps you handle objections and arms non-technical sales reps with product info exactly when it’s needed.",
    ...
    },
    {
      ...
      description:
        "Even without audio, Truely reads your screen and responds to prompts or context. Whether you're studying, debugging, writing, or researching, Truely helps you think.",
