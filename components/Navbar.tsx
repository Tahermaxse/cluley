    ...
    >
      <nav
        className={`mx-auto transition-all duration-500 ease-out ${
          isScrolled
            ? "max-w-4xl bg-white/95 backdrop-blur-md shadow-lg rounded-full border border-white/20"
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex lg:flex-1">
            <a className="flex items-center gap-x-1 transition border-b border-transparent hover:border-black" href="/">
              ...
              <span className="text-lg font-semibold transition">Cluely</span>
            </a>
          </div>
      ...
      {isMobileMenuOpen && (
        <>
          <div className="fixed inset-0 z-40 bg-black/20 backdrop-blur-sm" onClick={closeMobileMenu} />
          <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-zinc-900/10 sm:shadow-2xl">
            <div className="flex items-center justify-between">
              <a
              ...
              <button type="button" className="-m-2.5 rounded-md p-2.5 text-zinc-700" onClick={closeMobileMenu}>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-zinc-500/10">
                <div className="space-y-2 py-6">
                  <a
                    className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold text-zinc-900 hover:bg-zinc-50"
                    href="/#features"
                    onClick={closeMobileMenu}
                  >
                    How it works
                ...
                <div className="py-6">
                  <a
                    className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold text-zinc-900 hover:bg-zinc-50"
                    href="https://app.cluely.com/login"
                    onClick={closeMobileMenu}
                  >
                    Log in
