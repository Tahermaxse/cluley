...
const CTA = () => {
  return (
    <div className="relative mx-auto max-w-7xl py-60 mt-10 lg:mt-0 inset-ring-1 inset-ring-zinc-200 select-none">
      <img
        alt="hero-background"
        loading="lazy"
        decoding="async"
      ...
      <div className="relative ml-8 lg:text-center z-[1]">
        <span className="uppercase text-zinc-500 tracking-tight text-lg">
          Welcome to
        </span>
